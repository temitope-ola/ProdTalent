...
interface TalentAppointmentManagerProps {
  onClose: () => void;
}

const TalentAppointmentManager: React.FC<TalentAppointmentManagerProps> = ({ onClose }) => {
  const { user } = useAuth();
                  ...
                  <div style={{
                    ...
                    <div>
                      <h4 style={{ color: '#f5f5f7', margin: '0 0 4px 0' }}>
                        Coaching avec {appointment.coachName}
                      </h4>
