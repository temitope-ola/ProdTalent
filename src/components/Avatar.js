...
const Avatar = ({ size = 'medium', src, alt = 'Avatar', email, onClick, editable = false, onImageChange }) => {
    ...
    return (_jsxs("div", { style: {
            ...
            width: sizeMap[size],
            height: sizeMap[size]
        }, children: [_jsx("img", { src: avatarSrc, alt: alt, style: {
                    width: '100%',
                    height: '100%',
                    borderRadius: '4px',
                    objectFit: 'cover',
                ...
                }, onClick: handleImageClick, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false) }), editable && (_jsx("input", { ref: fileInputRef, type: "file", accept: "image/*", onChange: handleFileChange, style: { display: 'none' } })), editable && isHovered && (_jsx("div", { style: {
                    position: 'absolute',
                    top: '50%',
                    left: '50%',
