                ...
                margin: '0 auto'
                        ...
                        height: 'calc(100vh - 200px)'
                                ...
                                overflowY: 'auto'
                                            ...
                                            transition: 'background-color 0.2s'
                                        }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [_jsx("strong", { style: { color: message.read ? '#f5f5f7' : '#ffcc00' }, children: message.senderName }), !message.read && (_jsx("div", { style: {
                                                            width: '8px',
                                                            height: '8px',
                                                            backgroundColor: '#ffcc00',
                                                            borderRadius: '50%'
                                                    ...
                                                    whiteSpace: 'nowrap'
                                                }, children: message.content }), _jsx("small", { style: { color: '#666', fontSize: '12px' }, children: formatDate(message.timestamp) })] }, message.id))) }))] }), _jsx("div", { style: {
                                backgroundColor: '#111',
                                borderRadius: '4px',
                                padding: '16px',
                                display: 'flex',
                                flexDirection: 'column'
                                                    ...
                                                    borderRadius: '4px',
                                                    cursor: 'pointer'
                                                }, children: "Annuler" })] })] })) : selectedMessage ? (_jsxs("div", { style: { flex: 1, display: 'flex', flexDirection: 'column' }, children: [_jsxs("div", { style: { marginBottom: '16px' }, children: [_jsx("h3", { style: { color: '#ffcc00', marginTop: 0, marginBottom: '8px' }, children: selectedMessage.senderName }), _jsx("p", { style: { color: '#999', margin: 0 }, children: formatDate(selectedMessage.timestamp) })] }), _jsx("div", { style: {
                                            flex: 1,
                                            padding: '16px',
                                            backgroundColor: '#333',
                                            borderRadius: '4px',
                                            marginBottom: '16px'
                                        }, children: _jsx("p", { style: { margin: 0, lineHeight: '1.6' }, children: selectedMessage.content }) }), _jsx("button", { onClick: () => setIsComposing(true), style: {
                                            padding: '12px 24px',
                                            backgroundColor: '#ffcc00',
                                            color: '#000',
                                            border: 'none',
