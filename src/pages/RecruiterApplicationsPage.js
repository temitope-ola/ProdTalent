...
export default function RecruiterApplicationsPage() {
        ...
        try {
            ...
            for (const job of recruiterJobs) {
                try {
                    ...
                    const enrichedApplications = await Promise.all(jobApplications.map(async (app) => {
                        try {
    ...
    return (_jsx("div", { style: {
            ...
            color: '#f5f5f7'
                    ...
                    }, children: [_jsx("button", { onClick: () => navigate('/dashboard/recruteur'), style: {
                                padding: '8px 16px',
                        ...
                        textAlign: 'center'
                                ...
                                : `Aucune candidature ${getStatusText(filterStatus).toLowerCase()} trouvée.` })] })) : (_jsx("div", { style: { display: 'grid', gap: 16 }, children: filteredApplications.map((application) => (_jsxs("div", { style: {
                            backgroundColor: '#111',
                            padding: 20,
                            borderRadius: 4,
                            border: '1px solid #333'
                                            ...
                                            : application.coverLetter })] })), _jsxs("div", { style: { display: 'flex', gap: 12, justifyContent: 'flex-end' }, children: [_jsx("button", { onClick: () => handleViewJob(application.jobId), style: {
                                            padding: '8px 16px',
                                            backgroundColor: 'transparent',
                                            color: '#61bfac',
                                            ...
                                            cursor: 'pointer',
                                            fontSize: 14
                                        }, children: "Voir l'annonce" }), _jsx("button", { onClick: () => handleViewTalentProfile(application.talentId), style: {
                                            padding: '8px 16px',
                                            backgroundColor: 'transparent',
                                            color: '#ffcc00',
                                            border: '1px solid #ffcc00',
