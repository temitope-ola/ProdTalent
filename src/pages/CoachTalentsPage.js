            ...
            justifyContent: 'center'
                ...
                padding: '24px'
                        ...
                        marginBottom: 24
                                        ...
                                        borderRadius: '4px',
                                        cursor: 'pointer'
                                    }, children: "\u2190 Retour" }), _jsxs("h1", { style: { margin: 0, color: '#ffcc00' }, children: ["Mes Talents (", talents.length, ")"] })] }), _jsx("button", { onClick: handleLogout, style: {
                                padding: '8px 16px',
                                backgroundColor: '#333',
                                color: '#f5f5f7',
                                border: 'none',
                                borderRadius: '4px',
                                cursor: 'pointer'
                            }, children: "Se d\u00E9connecter" })] }), _jsxs("div", { style: { marginBottom: 24 }, children: [_jsx("h2", { style: { color: '#ffcc00', marginBottom: 8 }, children: "Tous les Talents" }), _jsx("p", { style: { color: '#f5f5f7', margin: 0 }, children: "D\u00E9couvrez et consultez les profils de tous les talents disponibles" })] }), _jsx("div", { style: {
                        display: 'grid',
                        ...
                        gap: 20
                            ...
                            height: '300px'
                                                    ...
                                                    margin: '0 0 8px 0',
                                                    fontSize: '14px'
                                                }, children: talent.email }), _jsx("p", { style: {
                                                    color: '#f5f5f7',
                                                    margin: '0 0 16px 0',
                                                    fontSize: '14px'
                                                }, children: "Consultez le profil complet et les comp\u00E9tences" })] })] }), talent.bio && (_jsx("div", { style: { marginBottom: 16 }, children: _jsx("p", { style: {
                                        color: '#f5f5f7',
                                        margin: 0,
                                        fontSize: '14px',
                                        lineHeight: '1.4',
                                        ...
                                        overflow: 'hidden'
                                            ...
                                            WebkitBoxOrient: 'vertical',
                                            overflow: 'hidden'
                                        }, children: talent.skills })] })), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 8, marginTop: 'auto' }, children: _jsx("button", { onClick: () => handleViewProfile(talent.id), style: {
                                        padding: '8px 16px',
                                        backgroundColor: 'transparent',
                                        color: '#ffcc00',
                                        border: '0.5px solid #ffcc00',
