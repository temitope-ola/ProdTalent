...
export class AvailabilityService {
    ...
    static async getAllCoachesWithAvailability() {
        try {
            ...
            const coachesWithAvailability = await Promise.all(allProfiles.map(async (coach) => {
    ...
    static async syncCoachAvailabilityFromSlots(coachId, availabilitySlots) {
        try {
