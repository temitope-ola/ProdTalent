...
class EmailNotificationService {
    ...
    async sendCoachingReservation(data) {
        ...
        try {
            const result = await emailjs.send(EMAILJS_CONFIG.SERVICE_ID, EMAILJS_CONFIG.TEMPLATES.COACHING_RESERVATION, templateParams);
    ...
    async sendAppointmentUpdate(data) {
        ...
        try {
            const result = await emailjs.send(EMAILJS_CONFIG.SERVICE_ID, EMAILJS_CONFIG.TEMPLATES.APPOINTMENT_UPDATE, templateParams);
    ...
    async sendNewMessage(data) {
        ...
        try {
            const result = await emailjs.send(EMAILJS_CONFIG.SERVICE_ID, EMAILJS_CONFIG.TEMPLATES.NEW_MESSAGE, templateParams);
    ...
    async sendNewProfileNotification(data) {
        ...
        for (const email of data.recruiterEmails) {
            try {
                const result = await emailjs.send(EMAILJS_CONFIG.SERVICE_ID, EMAILJS_CONFIG.TEMPLATES.NEW_PROFILE, { ...templateParams, to_email: email });
    ...
    async sendNewApplication(data) {
        ...
        try {
            const result = await emailjs.send(EMAILJS_CONFIG.SERVICE_ID, EMAILJS_CONFIG.TEMPLATES.NEW_APPLICATION, templateParams);
    ...
    async sendNewRecommendation(data) {
        ...
        try {
            // Envoyer au talent
            const talentResult = await emailjs.send(EMAILJS_CONFIG.SERVICE_ID, EMAILJS_CONFIG.TEMPLATES.NEW_RECOMMENDATION, talentParams);
        ...
        try {
            ...
            const recruiterResult = await emailjs.send(EMAILJS_CONFIG.SERVICE_ID, EMAILJS_CONFIG.TEMPLATES.NEW_RECOMMENDATION, recruiterParams);
    ...
    async sendNewJobPosting(data) {
        ...
        for (const email of data.talentEmails) {
            try {
                const result = await emailjs.send(EMAILJS_CONFIG.SERVICE_ID, EMAILJS_CONFIG.TEMPLATES.NEW_JOB_POSTING, { ...templateParams, to_email: email });
                results.push({ email, success: true });
    ...
    async testConfiguration() {
        ...
        try {
            ...
            const result = await emailjs.send(EMAILJS_CONFIG.SERVICE_ID, templateToTest, testParams);
